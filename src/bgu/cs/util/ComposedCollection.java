 ...
 */
public class ComposedCollection<T> extends AbstractCollection<T> {
	private final Collection<T> c1;
	private final Collection<T> c2;

	public ComposedCollection(Collection<T> c1, Collection<T> c2) {
		this.c1 = c1;
		this.c2 = c2;
	}
	...
	private class ComposedIterator implements Iterator<T> {
